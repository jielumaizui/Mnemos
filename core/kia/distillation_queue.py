...
用法：
    python3 core/kia/distillation_queue.py --list          # 列出待处理任务
    python3 core/kia/distillation_queue.py --next          # 获取下一个任务并标记为 processing
    python3 core/kia/distillation_queue.py --done {id}     # 标记任务完成
    python3 core/kia/distillation_queue.py --fail {id}     # 标记任务失败
"""
...
QUEUE_DIR = get_config().data_dir / "distill_queue"
