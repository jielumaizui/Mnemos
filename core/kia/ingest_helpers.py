...
_ENTITY_TECH_TERMS = {
    ...
    'Nginx', 'Apache', 'Traefik', 'HAProxy', 'Caddy', 'Envoy',
    'Prometheus', 'Grafana', 'ELK', 'Sentry', 'Datadog',
    'Terraform', 'Pulumi', 'Ansible', 'Chef', 'Puppet', 'SaltStack',
    'ArgoCD', 'Flux', 'Helm', 'Istio', 'Linkerd', 'Consul', 'Vault',
    'Nomad', 'Cilium', 'Calico', 'Longhorn', 'MinIO', 'Velero',
    'Kafka', 'Pulsar', 'NATS', 'RabbitMQ', 'ZeroMQ',
    'gRPC', 'tRPC', 'Protobuf', 'Avro', 'Thrift',
    'Parquet', 'Delta Lake', 'Iceberg', 'Hudi', 'DuckDB',
    'TiDB', 'CockroachDB', 'YugabyteDB', 'PlanetScale', 'MariaDB',
    'Jaeger', 'Zipkin', 'OpenTelemetry', 'Tempo',
    'Loki', 'Fluent Bit', 'Vector',
    'Falco', 'Trivy', 'Cosign', 'Sigstore',
    'SonarQube', 'Renovate', 'Dependabot',
    'Postman', 'Bruno', 'HTTPie', 'k6',
